...
## Phase 1 Motion Viewer
For the first step toward real-time multi-person tracking, `real-time/live_motion_viewer.py` adds:
* config parsing from the radar CLI cfg file
* generic TX/RX handling for building a radar cube
* static clutter suppression to emphasize moving targets

Before running it with ***IWR6843ISK-ODS***, update the cfg path near the top of `live_motion_viewer.py` to point at your real 3TX/4RX profile.
